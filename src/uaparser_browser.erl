...
get_version(Browser, UserAgent) ->
    case proplists:get_value(<<"version_regex">>, Browser) of
        undefined ->
            {<<"0">>, []};
        RX ->
...
-spec check_useragent(Browser :: tuple(), UserAgent :: binary()) -> 'undefined' | list().
check_useragent({Browser}, UserAgent) ->
    case contains(proplists:get_value(<<"aliases">>, Browser), UserAgent) of
        true ->
            case find(UserAgent, proplists:get_value(<<"children">>, Browser)) of
                undefined ->
                    case contains(proplists:get_value(<<"exclusions">>, Browser), UserAgent) of
                        true -> undefined;
                        false -> Browser
                    end;
                Result ->
...
inherit(Child, Parent) ->
    case proplists:get_value(<<"version_regex">>, Child) of
        undefined ->
            [proplists:get_value(<<"version_regex">>, Parent) | Child];
        _ ->
            Child
    end.
